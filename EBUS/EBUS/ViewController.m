...
- (void) emailResults {
    ...
    if (!isEmailValid) {
        ...
        [emailBody appendString:[NSString stringWithFormat:@"<p>Investing in Olympus technology is an important decision. Investing smarter in today's economy is a necessary one. That's why we've developed the Olympus EBUS Break Even Calculator. EBUS can be a compelling business proposition and major addition to your existing portfolio. EBUS – TBNA and Radial EBUS are now both recommended   in the new ACCP Lung   Cancer Guaidelines*.</p><p><ul><li>EBUS – TBNA best first choice for staging of the mediastinum *.</li><li>Radial EBUS can increase the diagnostic yield when sampling peripheral lung nodules *.</li><li>Olympus is the ONLY Company that can provide both Linear EBUS for staging the mediastinum and Radial EBUS to confirm the ideal location for sampling peripheral lung nodules.</li></ul></p><p>In an effort to assist our current and prospective customers with their own analyses, Olympus has developed a flexible EBUS Break Even Calculator. Please keep in mind the following Olympus points when performing your analysis:</p><p><ul><li>Olympus is the only company that offers Linear and Radial EBUS in one ultrasound processor: EU-ME1</li><li>The EU-ME1 is Olympus' most versatile ultrasound processor</li><li>Olympus quality is backed by 510K FDA regulations</li><li>Flexible financial options are available and can be tailored to meet your needs</li><li>Olympus Professional Education offers training courses on safe and effective use of Olympus equipment.</li><li>Olympus offers 24/7 technical support</li><li>Our customers can utilize web portals for repair history and equipment information</li></ul></p><p>Our broad Field Support Team is available to serve your needs.</p><p>This calculator illustrates how EBUS can help to improve the planning and budgeting process as well as generate a prospective return based on specific investment, cost and revenue assumptions. All relevant information to your current business situation has been included. Remember, this tool is designed to be flexible and to take into account your unique situation in terms of procedure volume, revenue, costs and the value of Olympus services that you plan to utilize going forward.</p><p>Thank you for your time and interest in Olympus' products and solutions. At Olympus, we appreciate the opportunity to partner with our customers to provide the most advanced and efficient care to your patients. We look forward to doing business with you.</p><p>Best Regards,</p><p>Olympus Endoscopy Account Manager</p><p style=\"font-size:9px; padding:10px 0;\">* CHEST 2013; 143(5)(Suppl):7S-37S</p>"]];
